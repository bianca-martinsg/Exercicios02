...
namespace WindowsFormsApplication1
{
    public partial class Form1 : Form
    {
        ...
        private void button1_Click(object sender, EventArgs e)
        {
            ...
            //Calculando a somatória
            somatoria = valor01 + valor02 + valor03;

            //Calculando a media aritmética
            media = (valor01 + valor02 + valor03) / 3;

            MessageBox.Show("Maior: " + Convert.ToString(maior) + Environment.NewLine +
                "Menor: " + Convert.ToString(menor) + Environment.NewLine +
                "Somatória: " + Convert.ToString(somatoria) + Environment.NewLine +
                "Média: " + Convert.ToString(media), 
                "Exercício 23", MessageBoxButtons.OK, MessageBoxIcon.Information);
        }
    }
}
